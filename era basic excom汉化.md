...
> ###### 5.13	[COPYCHARA <整形 角色编号>, <整形 角色编号>](#5.13)
...
1:向上方示例一样使用单独一个值<br>
2:满足从< 初始值>到< 终止值>的数组<br>
3 一列条件: <条件1>, <条件2>.<br>
可以使用"IS <运算符> <整形>"进行判定,例如"IS <= 30",则X满足小于等于30,将会执行<br>
在“<整形> TO <整形>”的情况下，例如“10 TO 20”，X大于等于10,小于等于20，将会执行<br>
